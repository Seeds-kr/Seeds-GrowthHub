  ...
  return (
    <PublicLayout>
      <div className="flex-1 flex flex-col items-center justify-center p-4 py-24">
        <div className="max-w-md w-full rounded-lg bg-card border border-border p-12 text-center flex flex-col items-center">
          ...
          <Link href="/">
            <Button className="w-full h-12">메인으로 돌아가기</Button>
          </Link>
        </div>
      </div>
    </PublicLayout>
