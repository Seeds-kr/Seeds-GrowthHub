...
export const ABOUT_DEFAULT: AboutContent = {
  title: "Seeds 소개",
  intro: "Seeds는 대한민국의 우수한 학생들을 선발하여 글로벌 리더로 성장할 수 있도록 지원하는 프리미엄 교육 프로그램입니다.",
  sections: [
    { heading: "우리의 미션", body: "단순한 학업 성취를 넘어, 사회적 문제에 공감하고 이를 해결할 수 있는 실천적 리더를 양성합니다. 다양한 분야의 전문가 멘토링과 실무 프로젝트를 통해 학생들의 잠재력을 최대한 끌어냅니다." },
  ],
  values: [
